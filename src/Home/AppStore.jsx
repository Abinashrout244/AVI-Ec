...
const AppStore = () => {
  return (
    <div className="flex flex-col gap-7 justify-center items-center h-[70vh] px-5 md:px-[380px] text-white">
      <Link to="/signup">
        <button className="btn-ghost w-[170px]">Sign up for free</button>
      </Link>
